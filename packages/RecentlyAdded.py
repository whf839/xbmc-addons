...
class Main:
    ...
    def _fetch_movie_info( self ):
        ...
        for count, movie in enumerate( movies ):
            ...
            self.WINDOW.setProperty( "LatestMovie.%d.AutoThumb" % ( count + 1, ), "special://profile/Thumbnails/Video/%s/auto-%s" % ( thumb_cache[ 0 ], thumb_cache, ) )
    ...
    def _fetch_tvshow_info( self ):
        ...
        for count, episode in enumerate( episodes ):
            ...
            self.WINDOW.setProperty( "LatestEpisode.%d.AutoThumb" % ( count + 1, ), "special://profile/Thumbnails/Video/%s/auto-%s" % ( thumb_cache[ 0 ], thumb_cache, ) )
