...
class Main:
    ...
    def _fetch_totals( self ):
        ...
        # set properties 
        self.WINDOW.setProperty( "Movie.Count" , movies_totals[ 0 ] )
        self.WINDOW.setProperty( "Movie.Watched" , movies_totals[ 1 ] )
        self.WINDOW.setProperty( "Movie.UnWatched" , str( int( movies_totals[ 0 ] ) - int( movies_totals[ 1 ] ) ) )
