...
# base paths
BASE_DATA_PATH = xbmc.translatePath( ( "/" ).join( [ "special://temp", "script_data", __scriptname__ ] ) ) 
BASE_SETTINGS_PATH = xbmc.translatePath( ( "/" ).join( [ "special://profile", "script_data", __scriptname__ ] ) )
