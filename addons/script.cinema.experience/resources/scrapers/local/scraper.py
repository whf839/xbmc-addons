...
class Main:
    xbmc.log("%s - Local Folder Trailer Scraper Started" % logmessage, xbmc.LOGNOTICE )
    # base paths
    ...
    def fetch_trailers( self ):
        xbmc.log("%s - Fetching Trailers" % logmessage, xbmc.LOGNOTICE )
        # get watched list
        self._get_watched()
    ...
    def _shuffle_trailers( self ):
        ...
        xbmc.log("%s - Shuffling Trailers" % logmessage, xbmc.LOGNOTICE )
