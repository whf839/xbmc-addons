...
__svn_url__ = "http://xbmc-addons.googlecode.com/svn/branches/plugins/music/Streamer%20Radio%20Plugin"
...
class Main:
    ...
    def save_xml_source( self, xmlSource ):
        try:
            ...
            # oops print error message and return unsuccessful
            print sys.exc_info()[ 1 ]
            return False
    ...
    def _fill_media_list_categories( self, categories ):
        try:
            ...
            for category in categories:
                url = '%s?title="""%s"""&levels=%s&isFolder=%d' % ( sys.argv[ 0 ], category.title, repr( category.levels ), category.isFolder )
