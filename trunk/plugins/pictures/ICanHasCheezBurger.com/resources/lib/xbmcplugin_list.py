...
#        self.entries_per_page = 5
    ...
    def getPictures( self ) :        
        ...
        # Next page entry...
        #
        listitem      = xbmcgui.ListItem (xbmc.getLocalizedString(30403) % (self.entries_per_page, self.lol_name), iconImage = "DefaultFolder.png", thumbnailImage = os.path.join(self.IMAGES_PATH, 'next-page.png'))
        ...
        # Label (top-right)...
        #
        xbmcplugin.setPluginCategory( handle=int( sys.argv[ 1 ] ), category=( "%s (%s)" % ( self.lol_name, ( xbmc.getLocalizedString(30402) % self.current_page ) ) ) )
