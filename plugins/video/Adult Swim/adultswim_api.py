...
EPISODES_BY_SHOW_URL = "http://asfix.adultswim.com/asfix-svc/episodeSearch/getEpisodesByShow?id=%s&filterByEpisodeType=%s"
EPISODES_BY_IDS_URL = "http://asfix.adultswim.com/asfix-svc/episodeSearch/getEpisodesByIDs?ids=%s"
