...
class RSSParser:
    def __init__(self):
        self.settings = {}
        self.settings[ "cache_time" ] = int(xbmcplugin.getSetting( "cache_time" ))*60
        self.settings[ "cache_rss" ] = xbmcplugin.getSetting( "cache_rss" ) == "true"
        self.settings['username_newzbin'] = xbmcplugin.getSetting('username_newzbin')
        self.settings['password_newzbin'] = xbmcplugin.getSetting('password_newzbin')
