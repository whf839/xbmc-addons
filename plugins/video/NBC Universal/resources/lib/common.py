...
#settings general
settings['resolution_hack'] = (xbmcplugin.getSetting("resolution_hack") == "true")
settings['quality']         = xbmcplugin.getSetting("quality")

#settings TV
settings['flat_season']        = int(xbmcplugin.getSetting("flat_season"))
settings['flat_channels']      = (xbmcplugin.getSetting("flat_channels") == "true")
settings['flat_tv_cats']       = (xbmcplugin.getSetting("flat_tv_cats") == "true")
settings['only_full_episodes'] = (xbmcplugin.getSetting("only_full_episodes") == "true")    
settings['show_epi_labels']    = (xbmcplugin.getSetting("show_epi_labels") == "true")    
settings['get_show_plot']      = (xbmcplugin.getSetting("get_show_plot") == "true")    
settings['get_episode_plot']   = (xbmcplugin.getSetting("get_episode_plot") == "true")
